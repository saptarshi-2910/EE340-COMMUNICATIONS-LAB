...
class TP2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab_layout_2.addWidget(self._qtgui_sink_x_1_0_win)
        ...
        self.blocks_throttle2_1 = blocks.throttle( gr.sizeof_gr_complex*1, audio_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * audio_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.blocks_throttle2_1_0, 0), (self.qtgui_sink_x_1_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.blocks_throttle2_1_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.qtgui_sink_x_1_0.set_frequency_range(0, self.audio_rate)
