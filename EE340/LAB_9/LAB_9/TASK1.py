...
class TASK1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_gr_complex*1, 11)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c((8*1e6), analog.GR_COS_WAVE, 500001, 1, 0, 0)
