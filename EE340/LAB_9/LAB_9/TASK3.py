...
class TASK3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'OUTPUT3.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_1 = blocks.add_vff(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_1 = analog.sig_source_f((8*1e6), analog.GR_SIN_WAVE, 500000, 3, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f((8*1e6), analog.GR_SIN_WAVE, 500001, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f((8*1e6), analog.GR_COS_WAVE, 500001, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_multiply_xx_0_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.blocks_add_xx_1, 1))
