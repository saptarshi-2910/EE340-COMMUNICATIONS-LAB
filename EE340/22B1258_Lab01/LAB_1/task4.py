...
class task4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_KAISER,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/saptarshi-biswas/Desktop/DESKTOP/EE340/LAB_1/shor.wav', True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/saptarshi-biswas/Desktop/DESKTOP/EE340/LAB_1/extract_shor.wav',
            1,
            samp_rate,
            blocks.FORMAT_WAV,
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 100, 7000, 50, window.WIN_KAISER, 6.76))
