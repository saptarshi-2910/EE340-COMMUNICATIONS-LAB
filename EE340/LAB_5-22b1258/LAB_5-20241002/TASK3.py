...
class TASK3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.root_raised_cosine_filter_1_0 = filter.fir_filter_fff(
            1,
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-0.00025), 0.00025, 0)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, (2 + 7*8))
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(8)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(1000, 1, 4000, 1)
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar()
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/LAB_5-20241002/Original_Text.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/LAB_5-20241002/OUT.txt', False)
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.root_raised_cosine_filter_1_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.root_raised_cosine_filter_1, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.root_raised_cosine_filter_1_0, 0), (self.blocks_abs_xx_0, 0))
        self.connect((self.root_raised_cosine_filter_1_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.root_raised_cosine_filter_1_0, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(7, self.samp_rate, (self.samp_rate/self.sps), self.alpha, (11*self.sps)))
        self.root_raised_cosine_filter_1_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), self.alpha, (11*self.sps)))
