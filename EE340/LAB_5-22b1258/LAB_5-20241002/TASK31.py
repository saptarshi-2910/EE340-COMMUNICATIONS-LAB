...
class TASK31(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TASK31")
        ...
        self._delay_range = qtgui.Range(0, 5, 1, 5, 200)
        ...
        self.blocks_skiphead_0_0_1_0 = blocks.skiphead(gr.sizeof_char*1, 6)
        ...
        self.blocks_file_sink_0_0_1_0 = blocks.file_sink(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/LAB_5-20241002/run.txt', False)
        ...
        self.connect((self.blocks_float_to_uchar_0_0, 0), (self.blocks_skiphead_0_0_1_0, 0))
        self.connect((self.blocks_moving_average_xx_0_0, 0), (self.qtgui_time_sink_x_0_0_1_0_0_1_1, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0_0_1_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_time_sink_x_0_0_1_0_0, 0))
...
def main(top_block_cls=TASK31, options=None):
