...
class TASK2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0_0 = filter.interp_fir_filter_ccc(sps, [1])
        self.interp_fir_filter_xxx_0_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0_0 = digital.chunks_to_symbols_bc([-1,1], 1)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(8)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/LAB_5-20241002/Original_Text.txt', True, 0, 0)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.digital_chunks_to_symbols_xx_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.root_raised_cosine_filter_1, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.root_raised_cosine_filter_1, 0), (self.qtgui_eye_sink_x_0, 0))
        self.connect((self.root_raised_cosine_filter_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(3, self.samp_rate, (self.samp_rate/self.sps), self.alpha, (11*self.sps)))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(5*self.samp_rate)
