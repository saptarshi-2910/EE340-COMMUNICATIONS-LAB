...
class TASK2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab.addTab(self.tab_widget_5, 'samples ')
        ...
        self.qtgui_time_sink_x_1_0_0_1_0.enable_control_panel(True)
        ...
        self.tab_layout_5.addWidget(self._qtgui_time_sink_x_1_0_0_1_0_win)
        ...
        self.tab_layout_4.addWidget(self._qtgui_time_sink_x_0_0_1_0_0_0_win)
        ...
        self.tab_layout_6.addWidget(self._qtgui_time_sink_x_0_0_1_0_0_win)
        ...
        self.tab_layout_3.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-0.000025), 0.000025, 0)
        self.blocks_skiphead_0_0_1_0_4 = blocks.skiphead(gr.sizeof_char*1, 69)
        self.blocks_pack_k_bits_bb_0_0_1_0_4 = blocks.pack_k_bits_bb(8)
        ...
        self.blocks_file_sink_0_0_1_0_4 = blocks.file_sink(gr.sizeof_char*1, 'tasktext2.txt', False)
        self.blocks_file_sink_0_0_1_0_4.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, delay)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.blocks_abs_xx_0 = blocks.abs_ff(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(400000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_delay_0, 0), (self.fir_filter_xxx_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_skiphead_0_0_1_0_4, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.qtgui_time_sink_x_2_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0_0_1_0_4, 0), (self.blocks_file_sink_0_0_1_0_4, 0))
        self.connect((self.blocks_skiphead_0_0_1_0_4, 0), (self.blocks_pack_k_bits_bb_0_0_1_0_4, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.blocks_float_to_uchar_0, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.qtgui_time_sink_x_1_0_0_1_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_0_0_1_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.root_raised_cosine_filter_1, 0))
        ...
        self.connect((self.root_raised_cosine_filter_1, 0), (self.qtgui_freq_sink_x_0_0_1, 0))
        self.connect((self.root_raised_cosine_filter_1, 0), (self.qtgui_time_sink_x_0_0_1_0_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(3, self.samp_rate, 10000, self.alpha, (11*self.sps)))
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 10000, 1, (11*self.sps)))
