...
class TASK3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._alpha_range = qtgui.Range(0, 5, 0.1, 0.8, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/Lab_6/tasktext3.txt', False)
        ...
        self.connect((self.blocks_threshold_ff_0_0, 0), (self.blocks_add_xx_1, 1))
