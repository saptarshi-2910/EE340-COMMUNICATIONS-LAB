...
class LAB41b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB41b")
        ...
        self._amplitude_range = qtgui.Range(0.0000, 0.03, 0.0001, 0.00001, 200)
...
def main(top_block_cls=LAB41b, options=None):
