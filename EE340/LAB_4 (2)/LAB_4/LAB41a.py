...
class LAB41a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB41a")
        ...
        self.amplitude = amplitude = 0.00001

        ##################################################
        # Blocks
        ##################################################

        self._amplitude_range = qtgui.Range(0.0000, 0.01, 0.0001, 0.00001, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((-(amplitude)/(2*0.025)))
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.blocks_throttle2_0, 0))
    ...
    def set_amplitude(self, amplitude):
        ...
        self.blocks_multiply_const_vxx_0.set_k((-(self.amplitude)/(2*0.025)))




def main(top_block_cls=LAB41a, options=None):
