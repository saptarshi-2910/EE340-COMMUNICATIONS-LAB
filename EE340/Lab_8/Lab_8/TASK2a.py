...
class TASK2a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TASK2a")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'output2a.txt', False)
...
def main(top_block_cls=TASK2a, options=None):
