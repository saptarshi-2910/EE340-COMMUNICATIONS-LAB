...
class TASK5B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TASK5B")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/Lab_6/Original_Text.txt', True, 0, 0)
...
def main(top_block_cls=TASK5B, options=None):
