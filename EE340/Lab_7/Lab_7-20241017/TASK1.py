...
class TASK1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab_layout_6.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.iir_filter_xxx_3 = filter.iir_filter_ccf([0.001], [1,0.98], True)
        ...
        self.blocks_multiply_const_vxx_0_1_0_0 = blocks.multiply_const_cc(eq_4)
        self.blocks_multiply_const_vxx_0_1_0 = blocks.multiply_const_cc(eq_3)
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_cc(eq_2)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(eq_1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/sappylappy/Desktop/DESKTOP/EE340/Lab_7-20241017/Original_Text.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'OUT1.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_1_0_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 160)
        self.blocks_delay_1_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 120)
        self.blocks_delay_1_0 = blocks.delay(gr.sizeof_gr_complex*1, 80)
        self.blocks_delay_1 = blocks.delay(gr.sizeof_gr_complex*1, 40)
        ...
        self.connect((self.blocks_add_xx_3, 0), (self.iir_filter_xxx_3, 0))
        ...
        self.connect((self.blocks_delay_1, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.blocks_delay_1_0, 0), (self.blocks_multiply_const_vxx_0_1, 0))
        self.connect((self.blocks_delay_1_0_0, 0), (self.blocks_multiply_const_vxx_0_1_0, 0))
        self.connect((self.blocks_delay_1_0_0_0, 0), (self.blocks_multiply_const_vxx_0_1_0_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.blocks_delay_1_0_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.blocks_delay_1_0_0_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_add_xx_3, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_add_xx_3, 1))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.blocks_add_xx_3, 2))
        self.connect((self.blocks_multiply_const_vxx_0_1_0, 0), (self.blocks_add_xx_3, 3))
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.blocks_add_xx_3, 4))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        self.connect((self.iir_filter_xxx_3, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_eq_4(self, eq_4):
        self.eq_4 = eq_4
        self.blocks_multiply_const_vxx_0_1_0_0.set_k(self.eq_4)
    ...
    def set_eq_3(self, eq_3):
        self.eq_3 = eq_3
        self.blocks_multiply_const_vxx_0_1_0.set_k(self.eq_3)
    ...
    def set_eq_2(self, eq_2):
        self.eq_2 = eq_2
        self.blocks_multiply_const_vxx_0_1.set_k(self.eq_2)
    ...
    def set_eq_1(self, eq_1):
        self.eq_1 = eq_1
        self.blocks_multiply_const_vxx_0_0.set_k(self.eq_1)
