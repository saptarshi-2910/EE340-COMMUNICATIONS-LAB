...
class TASK32(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TASK32")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/home/saptarshi29/Desktop/DESKTOP/EE340/Lab 2 Resources-20240820/data1.dat', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_add_xx_1 = blocks.add_vff(1)
        self.audio_sink_0 = audio.sink(vocal_rate, '', True)
    ...
    def set_vocal_rate(self, vocal_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.vocal_rate)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.vocal_rate)
...
def main(top_block_cls=TASK32, options=None):
